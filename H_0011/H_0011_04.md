...
**A:**  One of the tasks done by the gadrung was to write down everything, like writing down the plans, and we had to also write the approval notes [Tib. 'go mchan] on the petitions. Usually, we made all the drafts and then asked the kalön whatever they wanted to add or erase, and then they made the clean copy.   
